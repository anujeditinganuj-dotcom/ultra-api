...
def api_download():
    ...
    cmd = [
        ...
        # video pauses partway through" actually is. reconnect_at_eof
        # covers the CDN silently closing the stream early and ffmpeg
        # treating that as a normal end rather than retrying;
