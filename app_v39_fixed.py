...
def api_download():
    ...
    cmd = [
        ...
        # reconnect_delay_total bounds how long ffmpeg will keep retrying
        # in total, so a genuinely-dead CDN still fails within ~40s
        # instead of retrying indefinitely and leaving the browser
        # "downloading" forever with no way to tell the two cases apart.
        "-reconnect_at_eof", "1",
        "-reconnect_on_network_error", "1",
        "-reconnect_delay_total", "40",
